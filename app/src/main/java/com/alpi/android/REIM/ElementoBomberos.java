...
public class ElementoBomberos {
    ...
    public void setNombreElementoBomberos(String nombreElementoBomberos) {
        this.nombreElementoBomberos = nombreElementoBomberos;
    }

    public String getImagenElementoBomberos() {
        return imagenElementoBomberos;
    }

    public void setImagenElementoBomberos(String imagenElementoBomberos) {
